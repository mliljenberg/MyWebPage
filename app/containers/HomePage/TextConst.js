...
{ header: 'Visual Studio, C# and .Net',
  text: '<p>Working at Tetra pak I gained experience working in Visual studio with .net and C#. I have mostly used the MVC and the MVVM patterns to build web applications. <br /> <br /> Additionally, I have some experience working with the following technologies: <ul><li>C#</li><li>.net</li><li>MVC</li></ul></p>',
  src: vs,
  proficency: 'good' },
{ header: 'Android',
