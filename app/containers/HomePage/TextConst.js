...
},
{
  ...
  text: '<p>I was a part of the board of Directors at the Computer science-guild were I hold the position as head of corporate relations. This means that I am responsible for all contact with companies that wants to have a collaboration with the Computer science-guild. The committee I am head of consists of sixteen people who are working together to help companies market themselves towards computer engineering students, this is usually done by organizing events with the companies.<br /><br /> The year previous to becoming head of corporate relations I were responsible for the Computer science-guild fair called &ldquo;Teknikfokus&rdquo;. I worked with a project group that consisted of six people. As project manager I did everything from selling fair to the companies to organising and ensuring that both the students and the companies were satisfied with &ldquo;Teknikfokus&rdquo;. Our work resulted in the most successful &ldquo;Teknikfokus&rdquo; fair so far both economically and in the number of students visiting the fair.</p>',
  src: dsek,
  orient: true,
},
];
